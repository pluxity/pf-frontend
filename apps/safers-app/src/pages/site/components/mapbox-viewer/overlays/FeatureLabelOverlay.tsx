  ...
  useEffect(() => {
    const updateLabels = () => {
      ...
      for (const [id, pos] of positions) {
        const isCCTV = !!useFeatureDataStore.getState().getCCTVStreamUrl(id);
        ...
        label.style.transform = `translate(${pos.x}px, ${pos.y}px) translate(-50%, calc(-100% - 2rem))`;
        label.style.display = "";
      }
