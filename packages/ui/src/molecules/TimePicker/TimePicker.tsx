...
function TimePicker({
  ...
  return (
    <div ref={ref} className={cn("relative", className)}>
      ...
      {isOpen && (
        <div className="absolute left-0 top-full z-50 mt-1 rounded-lg border border-neutral-100 bg-white p-4 shadow-[0_0.25rem_0.75rem_rgba(0,0,0,0.10)] dark:border-dark-border-default dark:bg-dark-bg-card">
          <div className="flex items-center gap-4">
            <div className="flex flex-col items-center">
              <span className="mb-2 text-xs text-muted dark:text-dark-text-muted">Hour</span>
              <div className="flex flex-col items-center">
            ...
            <span className="mt-6 text-xl font-bold text-secondary dark:text-dark-text-secondary">
              :
            </span>

            <div className="flex flex-col items-center">
              <span className="mb-2 text-xs text-muted dark:text-dark-text-muted">Min</span>
              <div className="flex flex-col items-center">
            ...
            {use12Hour && (
              <div className="flex flex-col items-center">
                <span className="mb-2 text-xs text-muted dark:text-dark-text-muted">AM/PM</span>
                <div className="flex flex-col items-center">
