...
export const alertVariants = cva(
  "relative w-full rounded-md border p-4",
  {
    variants: {
      variant: {
        default:
          "bg-gray-50 border-gray-200 text-gray-900 [&>svg]:text-gray-600",
        info:
          "bg-alert-info-bg border-info-500 text-gray-800 [&>svg]:text-info-500 [&_.alert-title]:text-info-500",
        success:
