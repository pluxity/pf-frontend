  ...
  render: () => (
    <Footer>
      ...
      <Footer.Custom className="lg:col-span-2">
        <div className="rounded-lg border border-[#E6E6E8] p-4">
          <h4 className="mb-2 text-sm font-bold text-[#333340]">Newsletter</h4>
          <p className="mb-3 text-sm text-[#666673]">Stay updated with our latest news</p>
          <div className="flex gap-2">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 rounded-md border border-[#D9D9D9] px-3 py-2 text-sm focus:border-brand focus:outline-none"
            />
